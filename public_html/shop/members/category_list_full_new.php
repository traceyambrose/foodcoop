    ...
    while ( $row = mysql_fetch_array($resultp) )
      {
        ...
        $display .= '<table border="1" cellpadding="5" cellspacing="0" bordercolor="#DDDDDD" width="100%">';
        $display .= '<tr>';
        $display .= '<th align="center" bgcolor="#DDDDDD" width="10%">'.$font.' Order</font></th>';
        $display .= '<th align="center" bgcolor="#DDDDDD" width="10%">'.$font.' ID</font></th>';
        $display .= '<th align="center" bgcolor="#DDDDDD" width="55%">'.$font.' Product Name [<a href="'.BASE_URL.PATH."producers/".strtolower($producer_id).'.php">About Producer</a>]</font></th>';
        $display .= '<th align="center" bgcolor="#DDDDDD" width="10%">'.$font.' Type</font></th>';
        $display .= '<th align="center" bgcolor="#DDDDDD" width="15%">'.$font.' Price</font></th>';
        $display .= '</tr>';
...
<div align="center">
<table width="80%">
  <tr><td align="left"><?php echo $font;?>
