        ...
        while ( $row = mysql_fetch_array($rsr2) )
          {
            ...
            $sql = '
              ...
              WHERE
                ...
                AND '.TABLE_BASKET_ALL.'.basket_id = '.TABLE_BASKET.'.basket_id
                AND '.TABLE_BASKET.'.out_of_stock != "1"
                AND ('.TABLE_BASKET.'.future_delivery_id ="0"
                OR '.TABLE_BASKET.'.future_delivery_id ="'.$current_delivery_id.'")
              GROUP BY
                basket_id
              ORDER BY
            ...
            while ( $row = mysql_fetch_array($rs) )
              {
                ...
                $display_rt .= '
                  <li>
                  <a href="customer_invoice_print.php?basket_id='.$basket_id.'&member_id='.$member_id.'">
...
<html>
<head>
<title>Food <? echo ucfirst (ORGANIZATION_TYPE); ?> - Shop</title>
