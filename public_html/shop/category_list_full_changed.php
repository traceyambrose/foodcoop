...
while ( $row = mysql_fetch_array($rs) )
  {
    ...
    $sqlp = '
      ...
      WHERE
        ...
        AND '.TABLE_PRODUCT.'.donotlist = 0
        AND '.TABLE_PRODUCER.'.pending = 0 AND '.TABLE_PRODUCER.'.donotlist_producer = 0
        AND '.TABLE_PRODUCT.'.changed = 1
      GROUP BY
        '.TABLE_PRODUCT.'.producer_id
      ORDER BY
  ...
  <table width="80%">
    <tr>
      <td align="left"><?php echo $font;?>
        <div align="center">
        <h3>Product List Changed This Month: Sorted by Category</h3>
        </div>
